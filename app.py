...
Pre tags použij max 5 tagov z tohto zoznamu (alebo vlastné slovenské/anglické slovo): quick_win, cost_reduction, product, process, customer, technical, innovation, urgent, automation, hr, marketing, quality."""
    ...
    try:
        ...
        _upload_jobs[job_id] = {
            ...
            'result': {
                ...
                'message': 'Nápad úspšne zaznamenaný'
            }
        }
    except Exception as e:
